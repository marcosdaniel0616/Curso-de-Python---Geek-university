...
# Forma 1
s.remove(3)  # Não é índice! Informamos valor a ser removido.
...
# Imagine que temos 2 conjuntos: Um contendo estudantes do curso de Python e um
...
print(unicos1)
# {'Marcos', 'Ellen', 'Julia', 'Fernando', 'Patricia', 'Ana', 'Gustavo', 'Pedro', 'Guilherme'}
