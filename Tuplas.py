...
2 - As tuplas são imutáveis: Isso significa que ao criarmos uma tupla ela não muda. Toda
...
# OBS: gera erro (ValueError) se colocarmos um número diferente de valores para desempacotar.

# Métodos para adição, remoção de elementos não existem, dado o fato das tuplas serem imutáveis.
