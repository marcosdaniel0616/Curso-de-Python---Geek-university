...
OBS: Funções que retornam valores, devem retornar estes valores com a
...
# Vamos refatorar esta função para que ele retorne o valor
...
# Vamos criar uma função para jogara moeda
